...
* To replace tags add: `re:bad_tag1_>_good_tag1|re:bt1_>_bt1|re:bt2_>_gt2;re;` or `re:bad_tag_>_good_tag;re;` (only replaces one tag); one tag can be replaced with multiple tags, example of an alias and implication: `re:black_and_white_>_greyscale&#32;monochrome;re;` (`&#32;` = ` `)
